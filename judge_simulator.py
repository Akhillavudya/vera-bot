...
LLM_API_KEY = "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"  # <-- PUT YOUR API KEY HERE
...
class JudgeSimulator:
    ...
    def run(self, scenario: str) -> bool:
        ...
        scenarios = {
            ...
            "score_and_display":self._score_and_display,
...
def main():
    ...
    success = judge.run("full_evaluation")
